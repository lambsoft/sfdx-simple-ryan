...
node {
    ...
    def HUB_ORG=env.TRIAL_DEV_HUB_ORG_USER_RL
    def SFDC_HOST = env.SFDC_HOST_DH
    def JWT_KEY_CRED_ID = env.JWT_CRED_ID_OPENSSL
    def CONNECTED_APP_CONSUMER_KEY=env.TRIAL_DEV_HUB_CONNECTED_APP_CONSUMER_KEY_RL
